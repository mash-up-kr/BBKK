...
public class SummerFragment extends android.support.v4.app.Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    seasonBackground.setImageResource(R.drawable.season_summer);
    seasonTitle.setText(R.string.season_summer_title);
    seasonSubtitle.setText(R.string.season_summer_subTitle);
    return seasonLayout;
  }
}